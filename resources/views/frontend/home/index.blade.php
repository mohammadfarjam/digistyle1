        ...
        <div id="content" class="col-xs-12">
            ...
            <div class="slideshow single-slider owl-carousel" >
                @foreach($sliders as $slider)
                    <div style="width: 1140px;height: 560px;" class="item"><a href="#"><img class="img-responsive" src="{{$slider->photo->path}}"></a></div>
                 @endforeach
            ...
            <div class="marketshop-banner">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><a href="#"><img
                                src="images/Untitled.jpg" alt="2 Block Banner"
            ...
            <div class="category-module" id="latest_category">
                <h3 class="subtitle">مد و زیبایی - <a class="viewall" href=""></a></h3>
